...
chara2 = Character("", "Cynthia", "CYNTHIA", 100, 50, 90, 70, 70, 190, 15, 99, "none", [0,4,5,8], "The ancient scrolls predicted our meeting.", "How disappointing.", 20, 380, 200, './resources/cynthia-r.png', './resources/cynthia-l.png', chara2_cry)
characterlist.append(chara2)
chara3 = Character("", "Richard", "RICHARD", 100, 70, 70, 90, 50, 170, 25, 99, "none", [0,4,10,9], "Good day!", "I dare say if you were a cup of tea you'd be a cold one.", 20, 380, 200, './resources/richard-r.png', './resources/richard-l.png', chara3_cry)
characterlist.append(chara3)
chara4 = Character("  ", "Spider", "SPIDER", 100, 70, 70, 50, 90, 180, 20, 99, "none", [0,6,7,11], "...", "...........", 20, 380, 200, './resources/spider-r.png', './resources/spider-l.png', chara4_cry)
